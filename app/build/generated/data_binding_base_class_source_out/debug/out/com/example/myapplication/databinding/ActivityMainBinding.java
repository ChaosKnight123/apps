...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView, @NonNull Button btn1,
      @NonNull Button btn2, @NonNull FloatingActionButton fab, @NonNull Button next,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, btn1, btn2, fab, next, toolbar);
    }
